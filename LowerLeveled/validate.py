...
def validate_role_selection(interaction: discord.Interaction | Context, role: discord.Role | None, role_label: str) -> str | None:
    if role is None:
        return None
    if isinstance(interaction, discord.Interaction):
        ...
        if not guild_owner_bypasses_role_checks(interaction) and ctx.author.top_role <= role:
            return f"<:disapprove:1517452151012589662> You cannot configure a {role_label} that is equal or higher than your highest role."
